...
# AGILES,8.10.2022,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
...
while (True):
    ...
    # Step 5 - Remove a new item from the list/Table
        ...
        # TODO: Add Code Here
        while(True):
            strItem = input("Task to be removed: ").lower().strip()
            for row in lstTable:
                if row["Task"].lower().strip() == strItem:
                    bolFound = True
                    lstTable.remove(row)
